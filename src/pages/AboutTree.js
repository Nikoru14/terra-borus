        ...
        <div className="list">
            <div className="item">
                ...
                <div className="content">
                    <div className="author">ABOUT US</div>
                    <div className="title">TERRABORUS</div>
                    <div className="topic">LAGUNA STATE POLYTECHNIC UNIVERSITY</div>
                    <div className="des">
                        Terraborus, a research with LSPU-Siniloan Campus, is a pioneering Geographic Information System (GIS) merging with QR technology to map indigenous fruit and forest trees. 
                        Every tree is labeled with a unique QR code, allowing users to scan for essential details such as species, status, and content. 
                        This innovative approach not only enhances conservation efforts but also promotes community engagement and awareness in preserving our rich natural heritage.
                    </div>
                    <div className="buttons">
                        <button className="seeMoreBtn" data-popup="popupcontent1">SEE MORE</button>
                    </div>
                </div>
            </div>
            <div className="item">
                ...
                <div className="content">
                    ...
                    <div className="topic">SLIDER 1</div>
                    <div className="des">
                        Lorem ipsum dolor, sit amet consectetur adipisicing elit. Ut sequi, rem magnam nesciunt minima placeat, itaque eum neque officiis unde, eaque optio ratione aliquid assumenda facere ab et quasi ducimus aut doloribus non numquam. Explicabo, laboriosam nisi reprehenderit tempora at laborum natus unde. Ut, exercitationem eum aperiam illo illum laudantium?
                    </div>
                    <div className="buttons">
                        <button className="seeMoreBtn" data-popup="popupcontent2">SEE MORE</button>
                    </div>
                </div>
            </div>
            <div className="item">
                ...
                <div className="content">
                    <div className="title">DESIGN SLIDER</div>
                    <div className="topic">SLIDER 3</div>
                    <div className="des">
                        Lorem ipsum dolor, sit amet consectetur adipisicing elit. Ut sequi, rem magnam nesciunt minima placeat, itaque eum neque officiis unde, eaque optio ratione aliquid assumenda facere ab et quasi ducimus aut doloribus non numquam. Explicabo, laboriosam nisi reprehenderit tempora at laborum natus unde. Ut, exercitationem eum aperiam illo illum laudantium?
                    </div>
                    <div className="buttons">
                        <button className="seeMoreBtn" data-popup="popupcontent3">SEE MORE</button>
                    </div>
                </div>
            </div>
            <div className="item">
                ...
                <div className="content">
                    <div className="title">DESIGN SLIDER</div>
                    <div className="topic">SLIDER 4</div>
                    <div className="des">
                        Lorem ipsum dolor, sit amet consectetur adipisicing elit. Ut sequi, rem magnam nesciunt minima placeat, itaque eum neque officiis unde, eaque optio ratione aliquid assumenda facere ab et quasi ducimus aut doloribus non numquam. Explicabo, laboriosam nisi reprehenderit tempora at laborum natus unde. Ut, exercitationem eum aperiam illo illum laudantium?
                    </div>
                    <div className="buttons">
                        <button className="seeMoreBtn" data-popup="popupcontent4">SEE MORE</button>
                    </div>
                </div>
            </div>
        </div>
